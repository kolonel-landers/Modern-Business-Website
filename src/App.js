...
const TRANSLATIONS = {
  ...
  items: [
    {
      ...
      color: "#B03A30",
      flag: "🇨🇮",
      text: "Mr. LS a transformé ma boutique...",
      stars: 5,
    },
  ],
},
  ...
  steps: [
    {
      ...
      desc: "Nous échangeons par WhatsApp, email ou visioconférence pour comprendre votre projet, vos objectifs et votre budget. Un devis détaillé vous est envoyé sous 24h.",
      tag: "Gratuit",
    },
    {
      number: "02",
      icon: "📋",
      title: "Devis & Contrat",
      desc: "Vous recevez une proposition claire avec les délais, le prix et les services inclus. Après validation, un contrat est signé en ligne pour sécuriser notre collaboration.",
      tag: "En ligne",
    },
    {
      number: "03",
      icon: "💰",
      title: "Acompte 45%",
      desc: "Un acompte de 45% du montant total est requis pour démarrer le projet. Paiement accepté via Mobile Money (MTN, Orange), virement bancaire ou PayPal pour les clients internationaux.",
      tag: "Acompte 45%",
      highlight: true,
    },
    {
      ...
      desc: "Nous créons votre site avec des points de suivi réguliers. Vous validez le design avant le développement. Des retours sont intégrés à chaque étape via un lien de prévisualisation.",
      tag: "Suivi régulier",
    },
    {
      number: "05",
      ...
      desc: "Le site est testé sur tous les appareils (mobile, tablette, desktop) et navigateurs. Vous effectuez vos retours finaux. Les corrections sont appliquées jusqu'à votre satisfaction totale.",
    ...
    },
    {
      ...
      desc: "Le solde restant de 55% est réglé avant la mise en ligne. Votre site est ensuite déployé, vous recevez une formation complète et les accès. Le support post-livraison démarre.",
      tag: "Solde 55%",
    },
  ],
},
  ...
  projects: [
    {
      ...
      tag: "Local",
      tech: "ReactJS • SEO • Mobile",
      desc: "Site vitrine moderne pour un restaurant camerounais. Réservation en ligne, menu interactif et intégration WhatsApp. +60% de réservations en 2 mois.",
      color: "#B03A30",
      icon: "🍽️",
    },
    {
      ...
      category: "E-Commerce",
      tag: "Local",
      tech: "ReactJS • Mobile Money • SEO",
      desc: "Boutique en ligne pour une PME camerounaise vendant des produits artisanaux. Paiement MTN MoMo & Orange Money intégré. 150 commandes dès le premier mois.",
      color: "#F4A31F",
      icon: "🛍️",
    },
    {
      ...
      desc: "Plateforme de gestion RH pour une entreprise de Douala. Suivi des employés, congés automatisés et tableaux de bord en temps réel.",
      color: "#D5AF32",
      icon: "👔",
    },
    {
      ...
      category: "Site Vitrine",
      tag: "International",
      tech: "ReactJS • SEO Avancé • Analytics",
      desc: "Site hôtelier haut de gamme pour un client européen. Design UX/UI premium, réservation en ligne et référencement Google Top 3.",
      color: "#2C5F8A",
      icon: "🏨",
    },
    {
      ...
      category: "Application Web",
      tag: "International",
      tech: "ReactJS • Stripe • Dashboard",
      desc: "Plateforme SaaS de coaching sportif en ligne. Abonnements, suivi des séances, paiement Stripe. 500 utilisateurs actifs en 3 mois.",
      color: "#1A7A4A",
      icon: "💪",
    },
    {
      ...
      category: "Site Vitrine",
      tag: "International",
      tech: "ReactJS • Animation • SEO",
      desc: "Site d'agence digitale pour une startup londonienne. Animations avancées, chargement ultra-rapide (score 98/100 sur Lighthouse).",
      color: "#6B3FA0",
      icon: "🚀",
    },
    {
      ...
      category: "Site Vitrine",
      tag: "Local",
      tech: "ReactJS • Google Maps • SEO",
      desc: "Site clinique médicale à Yaoundé. Prise de rendez-vous en ligne, localisation Google Maps et fiche de chaque médecin.",
      color: "#B03A30",
      icon: "🏥",
    },
    {
      title: "DropZone Store",
      category: "E-Commerce",
      tag: "International",
      tech: "ReactJS • Stripe • Dropshipping",
      desc: "Boutique dropshipping internationale avec 80 produits. Paiement carte bancaire, gestion automatique des commandes et SEO produit optimisé.",
      color: "#F4A31F",
      icon: "📦",
    },
  ],
  ...
  items: [
    {
      name: "Adjoua Konan",
      role: "Owner — Fashion Boutique Abidjan",
      avatar: "AK",
      color: "#B03A30",
      flag: "🇨🇮",
      text: "Mr. LS transformed my online store in just a few weeks. Customers now order from their phones with Mobile Money. My revenue increased by 40% in the first month!",
      stars: 5,
    },
    {
      name: "Thomas Mbarga",
      role: "Director — Law Firm Yaoundé",
      avatar: "TM",
      color: "#F4A31F",
      flag: "🇨🇲",
      text: "Very professional and responsive. My site is modern, fast and well ranked on Google. The WhatsApp follow-up throughout the project was reassuring. Highly recommended.",
      stars: 5,
    },
    {
      name: "Sarah Mitchell",
      role: "Founder — FitCoach Pro, London",
      avatar: "SM",
      color: "#2C5F8A",
      flag: "🇬🇧",
      text: "Outstanding work. Mr. LS delivered exactly what I needed — a clean, fast and professional platform. Communication was smooth despite the time difference. Will definitely work together again.",
      stars: 5,
    },
    {
      name: "Inès Bello",
      role: "Entrepreneur — Restaurant Douala",
      avatar: "IB",
      color: "#D5AF32",
      flag: "🇨🇲",
      text: "My site is beautiful! Online reservations have exploded since launch. The team was patient, attentive and delivered on time. Thank you Mr. LS!",
      stars: 5,
    },
    {
      name: "Carlos Mendes",
      role: "CEO — TechStart Agency, Lisbon",
      avatar: "CM",
      color: "#1A7A4A",
      flag: "🇵🇹",
      text: "High quality work at a very competitive price. The site loads in under 2 seconds and ranked on Google's first page within 6 weeks. Excellent ROI and great communication throughout.",
      stars: 5,
    },
    {
      name: "Fatou Diallo",
      role: "Director — Education NGO, Dakar",
      avatar: "FD",
      color: "#6B3FA0",
      flag: "🇸🇳",
      text: "Mr. LS created our institutional site with great care and professionalism. The result exceeds our expectations. Our international donors are impressed by the quality.",
      stars: 5,
    },
  ],
},
  ...
  steps: [
    {
      ...
      desc: "We connect via WhatsApp, email or video call to understand your project, goals and budget. A detailed quote is sent within 24 hours.",
      tag: "Free",
    },
    {
      number: "02",
      ...
      desc: "You receive a clear proposal with deadlines, price and included services. After validation, a contract is signed online to secure our collaboration.",
      tag: "Online",
    },
    {
      number: "03",
      icon: "💰",
      title: "45% Deposit",
      desc: "A 45% deposit of the total amount is required to start the project. Payment accepted via Mobile Money (MTN, Orange), bank transfer or PayPal for international clients.",
      tag: "45% Deposit",
      highlight: true,
    },
    {
      ...
      desc: "We build your site with regular check-ins. You validate the design before development. Feedback is integrated at each stage via a preview link.",
      tag: "Regular updates",
    },
    {
      number: "05",
      ...
      desc: "The site is tested on all devices (mobile, tablet, desktop) and browsers. You give final feedback. Corrections are applied until your complete satisfaction.",
    ...
    },
    {
      ...
      desc: "The remaining 55% balance is paid before going live. Your site is then deployed, you receive full training and access credentials. Post-delivery support begins.",
      tag: "55% Balance",
    },
  ],
},
  ...
  projects: [
    {
      ...
      tag: "Local",
      tech: "ReactJS • SEO • Mobile",
      desc: "Modern showcase site for a Cameroonian restaurant. Online booking, interactive menu and WhatsApp integration. +60% bookings in 2 months.",
      color: "#B03A30",
      icon: "🍽️",
    },
    {
      ...
      tag: "Local",
      tech: "ReactJS • Mobile Money • SEO",
      desc: "Online store for a Cameroonian SME selling handcrafted products. MTN MoMo & Orange Money payment integrated. 150 orders in the first month.",
      color: "#F4A31F",
      icon: "🛍️",
    },
    {
      ...
      tag: "Local",
      tech: "ReactJS • Node.js • API",
      desc: "HR management platform for a Douala company. Employee tracking, automated leave management and real-time dashboards.",
      color: "#D5AF32",
      icon: "👔",
    },
    {
      ...
      category: "Showcase Site",
      tag: "International",
      tech: "ReactJS • Advanced SEO • Analytics",
      desc: "High-end hotel website for a European client. Premium UX/UI design, online booking and Google Top 3 ranking.",
      color: "#2C5F8A",
      icon: "🏨",
    },
    {
      ...
      tag: "International",
      tech: "ReactJS • Stripe • Dashboard",
      desc: "Online sports coaching SaaS platform. Subscriptions, session tracking, Stripe payment. 500 active users in 3 months.",
      color: "#1A7A4A",
      icon: "💪",
    },
    {
      ...
      tag: "International",
      tech: "ReactJS • Animation • SEO",
      desc: "Digital agency site for a London startup. Advanced animations, ultra-fast loading (98/100 Lighthouse score).",
      color: "#6B3FA0",
      icon: "🚀",
    },
    {
      ...
      tag: "Local",
      tech: "ReactJS • Google Maps • SEO",
      desc: "Medical clinic site in Yaoundé. Online appointment booking, Google Maps location and individual doctor profiles.",
      color: "#B03A30",
      icon: "🏥",
    },
    {
      ...
      tag: "International",
      tech: "ReactJS • Stripe • Dropshipping",
      desc: "International dropshipping store with 80 products. Card payment, automatic order management and optimized product SEO.",
      color: "#F4A31F",
      icon: "📦",
    },
  ],
      ...
      <Container>
          ...
          {getVisible().map((idx, pos) => {
            ...
            return (
              <div key={idx} style={{
                ...
                borderRadius: 24,
                padding: "32px 28px",
                border: `2px solid ${pos === 1 ? item.color + "40" : "#f0ece8"}`,
                transform: pos === 1 ? "scale(1.04)" : "scale(1)",
                boxShadow: pos === 1 ? `0 20px 50px ${item.color}20` : "none",
                transition: "all 0.4s ease",
              }}>
                {/* Étoiles */}
                <div style={{ marginBottom: 16 }}>
                  {"★".repeat(item.stars).split("").map((s, i) => (
                    <span key={i} style={{ color: COLORS.gold, fontSize: 18 }}>{s}</span>
                  ))}
                </div>
                ...
                {/* Auteur */}
                <div style={{ display: "flex", alignItems: "center", gap: 14, borderTop: "1px solid #f0ece8", paddingTop: 20 }}>
                  <div style={{
                    width: 48,
                    height: 48,
                    borderRadius: "50%",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 20 }}>
          <button onClick={prev} style={{
            ...
            fontSize: 20, color: COLORS.brick,
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {items.map((_, i) => (
              <button key={i} onClick={() => setCurrent(i)} style={{
                ...
                height: 8,
                borderRadius: 4,
                background: i === current ? COLORS.brick : "#e0d8d0",
                border: "none",
                cursor: "pointer",
                transition: "all 0.3s",
              }} />
...
function ProcessSection({ t }) {
  ...
  return (
    <Section id="process" style={{ background: "#faf9f7" }}>
      <Container>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{
            ...
            right: "8%",
            height: 2,
            background: `linear-gradient(90deg, ${COLORS.brick}, ${COLORS.orange}, ${COLORS.gold})`,
            zIndex: 0,
          }} />
              ...
              >
                ...
                <div style={{
                  ...
                  background: step.highlight
                    ? `linear-gradient(135deg, ${COLORS.brick}, ${COLORS.orange})`
                    : active === i
                    ? `linear-gradient(135deg, ${COLORS.brick}, ${COLORS.gold})`
                    : "#fff",
                  border: `3px solid ${step.highlight ? COLORS.orange : active === i ? COLORS.brick : "#e5e0d8"}`,
                  margin: "0 auto 16px",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: 26,
                  boxShadow: step.highlight || active === i
                    ? `0 8px 24px ${COLORS.brick}35`
                ...
                <span style={{
                  ...
                  background: step.highlight
                    ? `linear-gradient(135deg, ${COLORS.brick}, ${COLORS.orange})`
                    : `${COLORS.brick}12`,
                  color: step.highlight ? "#fff" : COLORS.brick,
                  borderRadius: 50,
                  padding: "3px 10px",
                  fontFamily: "'Poppins', sans-serif",
                  fontSize: 10,
          ...
          {active !== null && (
            <div style={{
              ...
              borderRadius: 20,
              padding: "32px 36px",
              border: `2px solid ${COLORS.brick}25`,
              boxShadow: `0 16px 48px ${COLORS.brick}12`,
              display: "flex",
              ...
              <div style={{
                ...
                height: 56,
                borderRadius: 14,
                background: `linear-gradient(135deg, ${COLORS.brick}15, ${COLORS.orange}15)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: 28,
                flexShrink: 0,
              }}>{t.process.steps[active].icon}</div>
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10 }}>
                  <h3 style={{
                    ...
                    fontWeight: 900,
                    color: "#0a0a0a",
                  }}>{t.process.steps[active].title}</h3>
                  <span style={{
                    background: t.process.steps[active].highlight
                      ? `linear-gradient(135deg, ${COLORS.brick}, ${COLORS.orange})`
                      : `${COLORS.brick}12`,
                    color: t.process.steps[active].highlight ? "#fff" : COLORS.brick,
                    borderRadius: 50,
                    padding: "4px 14px",
                    fontFamily: "'Poppins', sans-serif",
                    fontSize: 12,
                    fontWeight: 700,
                  }}>{t.process.steps[active].tag}</span>
                </div>
                <p style={{
                  fontFamily: "'Poppins', sans-serif",
                  fontSize: 15,
        ...
        <div style={{
          marginTop: 60,
          background: `linear-gradient(135deg, ${COLORS.brick}, #8a2520)`,
          borderRadius: 20,
          padding: "32px 40px",
          display: "flex",
          alignItems: "center",
          ...
          {[
            ...
            ["📝", "Contrat en ligne"],
            ["💰", "Acompte 45% au démarrage"],
            ["🚀", "Solde 55% à la livraison"],
          ].map(([icon, label]) => (
            <div key={label} style={{
              display: "flex",
              alignItems: "center",
...
function PortfolioSection({ t }) {
  ...
  return (
    <Section id="portfolio" style={{ background: "#fff", overflow: "hidden" }}>
      <Container>
            ...
            {getVisible().map((idx, pos) => {
              ...
              return (
                <div key={idx} style={{
                  background: "#fff",
                  borderRadius: 24,
                  border: `2px solid ${pos === 1 ? p.color : "#f0ece8"}`,
                  padding: "36px 28px",
                  transition: "all 0.4s ease",
                  transform: pos === 1 ? "scale(1.04)" : "scale(1)",
                  boxShadow: pos === 1 ? `0 20px 50px ${p.color}25` : "none",
                }}>
                  <div style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                    ...
                    <span style={{
                      background: p.tag === "Local" ? "#e8f5e9" : "#e3f2fd",
                      color: p.tag === "Local" ? "#2e7d32" : "#1565c0",
                      borderRadius: 50, padding: "4px 12px",
                      fontFamily: "'Poppins', sans-serif", fontSize: 11, fontWeight: 700,
                    }}>🌍 {p.tag}</span>
                  </div>
                  <h3 style={{
                    fontFamily: "'Merriweather', serif", fontSize: 20, fontWeight: 900,
                    color: "#0a0a0a", marginBottom: 12,
                  }}>{p.title}</h3>
                  <p style={{
                    fontFamily: "'Poppins', sans-serif", fontSize: 14,
                    color: "#666", lineHeight: 1.7, marginBottom: 16,
                  }}>{p.desc}</p>
                  <div style={{
                    borderTop: "1px solid #f0ece8", paddingTop: 16,
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {[
                  ["📧", "monsieurls100@gmail.com"],
                  ["💬", "WhatsApp: +237 697 13 43 68"],
                  ["🌍", "Douala, Cameroun — International"],
                ].map(([icon, text]) => (
...
function ContactForm({ t }) {
  ...
  return (
    <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      {error && (
        <p style={{ color: "#B03A30", fontFamily: "'Poppins', sans-serif", fontSize: 14 }}>
          ⚠️ {error}
        </p>
      )}
